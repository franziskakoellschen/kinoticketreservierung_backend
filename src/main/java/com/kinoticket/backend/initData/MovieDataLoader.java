...
public class MovieDataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws IOException, ParseException {
        ...
        filmShowList.add(new FilmShow(1l, result, new Time(2,4,5),null));
        filmShowList.add(new FilmShow(1l, new Date(), new Time(2,4,5),null));
        ...
        movieRepository.save(new Movie(15, "Test Movie",
                ...
                16, "https://www.youtube.com/watch?v=pGi3Bgn7U5U", filmShowList, "someImageUrl", "Peter Pan, Rafael Martin, Gregor Münker" , new Date() , 221 , "USA" , "Comedy", 42));
    }
}