...
public class MovieTests {
    ...
    void toStringTest() {
        Movie movieA = new Movie(15, "Test Movie", 2000, "This is a Description", "This is a full Description", 16,
                ...
                "someTemplateUrl");
        assertEquals(
            "Movie(id=15, title=Test Movie, year=2000, shortDescription=This is a Description, description=This is a full Description, fsk=16, trailer=someTrailerUrl, filmShows=[], imageUrl=someImageUrl, actors=Peter Maffay, startDate=null, filmLength=222, originCountry=USA, genre=Comedy, templateUrl=someTemplateUrl)",
            movieA.toString()
        );
    }
}
